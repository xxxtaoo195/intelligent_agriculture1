...
$axure.internal(function($ax) {
    // TODO: Probably a iot of the dynamic panel functions from pagescript should be moved here at some point...
    ...
    var _compressChildrenHelper = function (id, children, vert, threshold, delta, clamp, easing, duration, parentLayer) {
        ...
        for (var i = 0; i < children.length; i++) {
            ...
            // TODO: Played with this a iot, went with a safer fix, but I don't like the catch all with !$obj(childId), should handle these cases explicitally.
