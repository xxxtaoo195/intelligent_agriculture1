...
public class DeviceServiceImpl implements DeviceService {
    ...
    public List<DeviceGather> getHistoryDataByFarmId(PageTableRequest pageTableRequest,Long farmId) {
        ...
        String deviceIdObj = pageTableRequest.getParams().get("deviceId").toString();
        if (!StringUtils.isEmpty(deviceIdObj)) {
            String deviceId = deviceIdObj;
    ...
    @Override
    public List<DeviceGather> getGatherInfo(String monpointsid) {
        return deviceGatherDao.getGatherInfo(monpointsid);
    }

    @Override
    public List<DeviceCon> listDeviceCon(String monpointsid) {
        return deviceConDao.listDeviceCon(monpointsid);
    }

    @Override
    public List<DeviceGather> getGatherInfoList(String mid, String monpointsid) {
        return deviceGatherDao.getGatherInfoList(mid,monpointsid);
    }

    @Override
    public Map<Long, List<DeviceGatherCharts>> echartsDeviceShow(PageTableRequest pageTableRequest) {


        String mid = (String) pageTableRequest.getParams().get("mid");
        String deviceId = (String) pageTableRequest.getParams().get("deviceId");
        ...
        pageTableRequest.getParams().put("deviceId",deviceId);
        pageTableRequest.getParams().put("mid",mid);
        List<DeviceGatherCharts> DeviceGatherChartsList=deviceGatherDao.echartsDeviceShow(pageTableRequest);
        viewChartsData.put(Long.parseLong(deviceId),DeviceGatherChartsList);
        return viewChartsData;

    }

    @Override
    public List<Device> getByMidDeviceInfo(String mid) {
        return deviceDao.getByMidDeviceInfo(mid);
    }
