...
public class DeviceController {
    ...
    @GetMapping("/monpointsInfo/{mid}")
    @ApiOperation(value = "查询")
    public PageTableResponse monpointsInfo(@PathVariable String mid,PageTableRequest request) {

        request.getParams().put("mid",mid);
        ...
        return new PageTableHandler(new CountHandler() {
            ...
            @Override
            public int count(PageTableRequest request) {
                return deviceDao.countMonpoints(request.getParams());
            }
        }, new ListHandler() {

            @Override
            public List<Device> list(PageTableRequest request) {
                return deviceDao.listMonpoints(request.getParams(), request.getOffset(), request.getLimit());
            }
        }).handle(request);
    }
