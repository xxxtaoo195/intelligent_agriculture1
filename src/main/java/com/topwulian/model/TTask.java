...
public class TTask extends BaseEntity<Long> {
	...
	private String inputsBatchesId; //投入品批次编号
	private String inputsActNumber; //投入品ID
	...
	private InputsAct inputsAct; //投入品

	public InputsAct getInputsAct() {
		return inputsAct;
	}

	public void setInputsAct(InputsAct inputsAct) {
		this.inputsAct = inputsAct;
	}

	public String getInputsActNumber() {
		return inputsActNumber;
	}

	public void setInputsActNumber(String inputsActNumber) {
		this.inputsActNumber = inputsActNumber;
	}

	public String getInputsBatchesId() {
		return inputsBatchesId;
	}

	public void setInputsBatchesId(String inputsBatchesId) {
		this.inputsBatchesId = inputsBatchesId;
	}
