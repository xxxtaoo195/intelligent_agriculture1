...
public class EtContextConfig {
    ...
    */
    ...
    //public static String DOMAIN = "120.25.247.155";

    // public static final String APP_KEY = "4cdad356-85b4-008627";
    public static String APP_KEY = "d0cef040-a1ae-513349";

    // public static final String SECRET_KEY = "c7147f6fea0daf6cbd36ed65b037b4c9";
    public static String SECRET_KEY = "30b8b699e234eed1c0d62dc8c3116e63";

    //邓刚申请的uid
   //public static final String UID = "Fc5wGsTuvumomVomKrCa7mowfUpzALGeb6";
//    //硬件那边的新uid
   //public static final String RECEIVE_UID = "Fc5wGsTuvumomVom6Dt1vRmVp215AqKvxB";

    //我自己申请的uid
    public static String UID = "Fc5wGsTuvumomVomDqvhRcWiMWpyw4yRkq";
    public static String RECEIVE_UID = "Fc5wGsTuvumomVomDqvhRcWiMWpyw4yRkq";
