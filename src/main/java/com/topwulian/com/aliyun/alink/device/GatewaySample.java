...
public class GatewaySample extends BaseSample {
    ...
    private String testPublishTopic = "/sys/a1Nd9HwQYVF/testDemo/thing/event/property/post";
    private String testSubscribePropertyService = "/sys/a1Nd9HwQYVF/testDemo/thing/service/property/set";
