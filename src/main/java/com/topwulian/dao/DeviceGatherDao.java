...
public interface DeviceGatherDao {
    ...
    List<DeviceGather> getGatherInfo(@Param("monpointsid") String monpointsid);

    List<DeviceGather> getGatherInfoList(@Param("mid") String mid,@Param("monpointsid") String monpointsid);

    List<DeviceGatherCharts> echartsDeviceShow(PageTableRequest pageTableRequest);
