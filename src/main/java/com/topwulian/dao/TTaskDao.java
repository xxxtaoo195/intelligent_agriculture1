...
public interface TTaskDao {
    ...
    @Update("update t_task set desc_content=#{descContent},activity_date=#{activityDate},finish_date=#{finishDate},create_time=#{createDate},producter_id=#{producterId},makeArea=#{makeArea},makeMassif=#{makeMassif},state=1 where id = #{id}")
    int updatePull(TTask tTask);

    @Update("update t_task set desc_content=#{descContent},activity_date=#{activityDate},finish_date=#{finishDate},create_time=#{createDate},producter_id=#{producterId},inputsBatchesId=#{inputsBatchesId},inputsActNumber=#{inputsActNumber},makeArea=#{makeArea},makeMethod=#{makeMethod},makeMassif=#{makeMassif},state=1 where id = #{id}")
    int updatePull2(TTask tTask);
